        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        <a href="/customers/edit/{{\Illuminate\Support\Facades\Auth::user()->customer_id}}" class="nav-link">
                            <i class="nav-icon fas fa-calculator"></i>
                            <p>
                                Profile
                            </p>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        <a href="/customerspool" class="nav-link">
                            <i class="nav-icon fas fa-calculator"></i>
                            <p>
                               Customer Pool
                            </p>
                    ...
                    <li class="nav-item has-treeview menu-open">
                        <a href="/customersprocess" class="nav-link">
                            <i class="nav-icon fas fa-user"></i>
                            <p>
                                Processed Customers
                            </p>
